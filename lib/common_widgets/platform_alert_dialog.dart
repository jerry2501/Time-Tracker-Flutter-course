...
class PlatformAlertDialog extends PlatformWidget{
  PlatformAlertDialog({@required this.title,this.cancelActionText,@required this.content,@required this.defaultActionText}):
  ...
  Future<bool> show(BuildContext context) async{
    ...
    //this suggest the current object or instance
